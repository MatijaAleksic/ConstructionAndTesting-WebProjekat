...
public class ResourantTablesConstants {
    ...
    public static final Long DB_RESTOURANT_TABLE_NUMBER_UNIT1 =3L;
    public static final Integer DB_RESTOURANT_TABLE_FLOOR_UNIT1 =1;
    public static final Double DB_RESTOURANT_TABLE_POSITION_X_UNIT1 = 1.0;
    public static final Double DB_RESTOURANT_TABLE_POSITION_Y_UNIT1 = 2.0;
    public static final TableStatus DB_RESTOURANT_TABLE_STATE_UNIT1 = TableStatus.free;
    public static final Boolean DB_RESTOURANT_TABLE_IS_DELETED_UNIT1 = false;

    public static final Long DB_RESTOURANT_TABLE_NUMBER_UNIT2 =3L;
    public static final Integer DB_RESTOURANT_TABLE_FLOOR_UNIT2 =1;
    public static final Double DB_RESTOURANT_TABLE_POSITION_X_UNIT2 = 1.0;
    public static final Double DB_RESTOURANT_TABLE_POSITION_Y_UNIT2 = 2.0;
