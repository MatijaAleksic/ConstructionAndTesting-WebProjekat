...
public class WaiterConstants {
    ...
    public static final String DB_WAITER_FIRSTNAME_UNIT1 ="FIRSTNAME1";
    public static final String DB_WAITER_LASTNAME_UNIT1 ="LASTNAME1";
    public static final String DB_WAITER_USERNAME_UNIT1 = "USERNAME1";
    public static final String DB_WAITER_PASSWORD_UNIT1 = "PASSWORD1";
    public static final Date DB_WAITER_DATE_OF_BIRTH_UNIT1 = new Date(2015, Calendar.DECEMBER, 11);
    public static final Long DB_WAITER_SALARY_UNIT1 = 999L;
    public static final Boolean DB_WAITER_IS_DELETED_UNIT1 = false;

    public static final String DB_WAITER_FIRSTNAME_UNIT2 ="FIRSTNAME2";
    public static final String DB_WAITER_LASTNAME_UNIT2 ="LASTNAME2";
    public static final String DB_WAITER_USERNAME_UNIT2 = "USERNAME2";
    public static final String DB_WAITER_PASSWORD_UNIT2 = "PASSWORD2";
    public static final Date DB_WAITER_DATE_OF_BIRTH_UNIT2 = new Date(2017, Calendar.DECEMBER, 11);
    public static final Long DB_WAITER_SALARY_UNIT2 = 555L;
    public static final Boolean DB_WAITER_IS_DELETED_UNIT2 = false;

    public static final int FIND_ALL_NUMBER_OF_WAITER_UNIT = 3;
    public static final Long DB_SAVED_WAITER_ID_UNIT= 2L;
    public static final Boolean DB_WAITER_IS_DELETED_UNIT = true;
}
