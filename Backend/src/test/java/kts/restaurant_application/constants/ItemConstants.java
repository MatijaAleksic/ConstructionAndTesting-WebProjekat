...
public class ItemConstants {
    ...
    public static final String DB_ITEM_DESCRIPTION_UNIT1 ="DESCRIPTION1";
    public static final String DB_ITEM_NAME_UNIT1 ="NAME1";
    public static final String DB_ITEM_STATUS_UNIT1 = "active";
    public static final Double DB_ITEM_PRICE_UNIT1 = 255.0;
    public static final Byte DB_ITEM_PRIPRITY_UNIT1 = 3;
    public static final String DB_ITEM_SUBCATEGORY_UNIT1 = "SUBCATEGORY1";
    public static final Boolean DB_ITEM_IS_DELETED_UNIT1 = false;


    public static final String DB_ITEM_DESCRIPTION_UNIT2 ="DESCRIPTION2";
    public static final String DB_ITEM_NAME_UNIT2 ="NAME2";
    public static final String DB_ITEM_STATUS_UNIT2 = "active";
    public static final Double DB_ITEM_PRICE_UNIT2 = 2555.0;
    public static final Byte DB_ITEM_PRIPRITY_UNIT2 = 1;
    public static final String DB_ITEM_SUBCATEGORY_UNIT2 = "SUBCATEGORY2";
    public static final Boolean DB_ITEM_IS_DELETED_UNIT2 = false;

    public static final int FIND_ALL_NUMBER_OF_ITEM_UNIT = 3;
    public static final Long DB_SAVED_ITEM_ID_UNIT= 2L;
