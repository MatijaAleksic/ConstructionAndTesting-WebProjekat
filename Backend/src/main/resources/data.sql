...
--password = 'waiter'
INSERT INTO _users (username,password, is_deleted, date_of_birth, first_name, last_name, salary) VALUES ('waiter@gmail.com','$2a$12$ASufyVuKN1IR0iCYBzCfDeeFxg.ScluNfIiHw07o9O53bZMRrXYI6', false, '2012-12-12', 'Pera', 'Peric', 20000);
...
INSERT INTO _tables (floor, positionX, positionY, state, is_deleted) VALUES (1, 1.0, 2.0, 'free', false);
INSERT INTO _tables (floor, positionX, positionY, state, is_deleted) VALUES (4, 30.0, 2.0, 'free', false);
...
INSERT INTO _ordered_items (state, number, note,  date_time, item_id, staff_id, price, _id) VALUES ('ordered', 2, 'alergija na kikiriki', '2012-12-12', 1, 9, 200, 1);
