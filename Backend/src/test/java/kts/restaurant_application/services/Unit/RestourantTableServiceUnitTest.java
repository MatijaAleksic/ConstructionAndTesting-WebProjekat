...
public class RestourantTableServiceUnitTest {
    ...
    public void testFindAll() {
        ...
        RestourantTables RestourantTables2 = new RestourantTables(DB_RESTOURANT_TABLE_NUMBER_UNIT1, DB_RESTOURANT_TABLE_FLOOR_UNIT1, DB_RESTOURANT_TABLE_POSITION_X_UNIT1, DB_RESTOURANT_TABLE_POSITION_Y_UNIT1,DB_RESTOURANT_TABLE_STATE_UNIT1, DB_RESTOURANT_TABLE_IS_DELETED_UNIT1 );
        RestourantTables RestourantTables3 = new RestourantTables(DB_RESTOURANT_TABLE_NUMBER_UNIT2, DB_RESTOURANT_TABLE_FLOOR_UNIT2, DB_RESTOURANT_TABLE_POSITION_X_UNIT2, DB_RESTOURANT_TABLE_POSITION_Y_UNIT2,DB_RESTOURANT_TABLE_STATE_UNIT2, DB_RESTOURANT_TABLE_IS_DELETED_UNIT2 );
    ...
    public void testFindOne() {
        RestourantTables RestourantTables1 = new RestourantTables(DB_NEW_RESTOURANT_TABLE_NUMBER, DB_NEW_RESTOURANT_TABLE_FLOOR, DB_NEW_RESTOURANT_TABLE_POSITION_X, DB_NEW_RESTOURANT_TABLE_POSITION_Y,DB_NEW_RESTOURANT_TABLE_STATE, DB_NEW_RESTOURANT_TABLE_IS_DELETED );
