package kts.restaurant_application.config;

import kts.restaurant_application.security.TokenUtils;
import kts.restaurant_application.security.auth.RestAuthenticationEntryPoint;
import kts.restaurant_application.security.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests().antMatchers("/api/cultural-content-category", "/h2-console/**").permitAll()
